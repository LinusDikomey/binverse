...
use crate::{serialize::{Deserialize, Serialize}, streams::{Deserializer, Serializer}};
...
impl Deserialize for f32 {
    fn deserialize<R: Read>(d: &mut Deserializer<R>) -> Self {
        unsafe { std::mem::transmute::<u32, _>(d.deserialize()) }
    }
}
...
impl Deserialize for f64 {
    fn deserialize<R: Read>(d: &mut Deserializer<R>) -> Self {
        unsafe { std::mem::transmute::<u64, _>(d.deserialize()) }
    }
}